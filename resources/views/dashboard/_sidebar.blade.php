...
{{--        </a>--}}
    ...
    <div class="flex items-center px-6 py-2 mt-4 text-gray-500 absolute bottom-2 left-2" href="/forms">
        ...
        <span class="mx-3 text-xs">Made by <a class="font-semibold text-blue-400 hover:text-blue-600" href="https://aouabe-boubker.vercel.app/" target="_blank">Aouabe Boubker</a> </span>
    </div>
</div>
