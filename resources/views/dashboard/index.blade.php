...
@section('body')
    ...
    <div class="flex flex-col mt-8">
        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <h1 class="font-semibold text-3xl text-gray-700">The newest users</h1>
            <div class="align-middle inline-block min-w-full mt-3 shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
